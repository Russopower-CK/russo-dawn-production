(function () {
  ...
  function addDesktopStickyNavigationStyles() {
    ...
    style.textContent = [
      ...
      '    pointer-events: auto;',
      '  }',
      '  .header__menu_wrapper .list-menu--inline {',
      ...
      '    white-space: nowrap;',
      '  }',
      '  .header__menu_wrapper .list-menu--inline > li {',
      '    display: block;',
      '    flex: 0 0 auto;',
      '    width: auto;',
      '  }',
      '  .header__menu_wrapper header-menu,',
      '  .header__menu_wrapper details,',
      '  .header__menu_wrapper summary,',
      '  .header__menu_wrapper a {',
      '    position: relative;',
      '    pointer-events: auto !important;',
      '  }',
      '  .header__menu_wrapper .header__menu-item {',
      '    display: flex !important;',
      '    align-items: center;',
      '    gap: 0.55rem;',
      '    white-space: nowrap;',
      '  }',
      '  .header__menu_wrapper summary.header__menu-item > svg {',
      '    display: block !important;',
      '    flex: 0 0 auto;',
      ...
      '    pointer-events: none;',
      '  }',
      '  .header__menu_wrapper .mega-menu__content,',
      '  .header__menu_wrapper .header-dropdown-menu__list {',
      '    z-index: 30;',
      '    pointer-events: auto;',
      '  }',
      '}',
      ...
      '    letter-spacing: 0;',
      '  }',
      '  .header_secondary_wraper .list-menu--inline {',
      '    flex-wrap: nowrap !important;',
      '    white-space: nowrap;',
      '  }',
      '}',
